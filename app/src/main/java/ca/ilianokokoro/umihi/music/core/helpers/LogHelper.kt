...
object LogHelper {
    ...
    /**
     * Lyrics pipeline diagnostics stay visible in release builds so a
     * provider/parser fallback cannot look like an unexplained UI problem.
     * Do not put credentials or raw response bodies in these messages.
     */
    fun printLyrics(message: String) {
        Log.i(LYRICS_TAG, message)
    }

    ...
    Scaffold { paddingValues ->
        Column(
            ...
            Column(
                ...
                // The elevated, full-width field keeps the search action
                // prominent while the clear action makes repeated searches
                // quick on both touch and keyboard.
                SearchBar(
            ...
            when {
                ...
                isSearching -> {
                    when (val screenState = uiState.screenState) {
                        ScreenState.Loading,
                        ScreenState.Typing -> LoadingAnimation()

...
object Constants {
    ...
    object Lyrics {
        // LRCLIB is the only source for time-synchronized lyrics.
        const val LRCLIB_BASE_URL = "https://lrclib.net/api"
        const val LRCLIB_GET_CACHED_URL = "$LRCLIB_BASE_URL/get-cached"
        const val LRCLIB_SEARCH_URL = "$LRCLIB_BASE_URL/search"
        const val LRCLIB_GET_URL = "$LRCLIB_BASE_URL/get"
        const val LRCLIB_USER_AGENT =
            "Laya Music v1.0 (+https://github.com/nishan-bajagain/laya-music)"
        ...
        const val RETRY_INITIAL_DELAY_MS = 600L

        const val RECONCILE_EVERY_N_TICKS = 10
    ...
    object Player {
        // Progress is used for the seek bar and lyrics highlighting. 250ms is
        // responsive to the user while avoiding ~7 full-screen recompositions
        // per second during normal playback and scrolling.
    ...
    object YoutubeApi {
        ...
        object Next {
            val URL get() = "${ORIGIN}/youtubei/v1/next?key=${API_KEY}&prettyPrint=false"
        }
        ...
        object Client {
            ...
            val ANDROID_MUSIC =
                buildJsonObject {
                    ...
                    put("clientVersion", JsonPrimitive("7.21.50"))
                }

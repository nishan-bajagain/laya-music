...
data class CachedLyrics(
    ...
    val provider: String,
    /**
     * Optional serialized timed-line/word data retained for compatible cache
     * rows. New LRCLIB results use syncedLyrics as the canonical timing input.
     */
    val timedLinesJson: String? = null,

...
class HomeViewModel(application: Application) : AndroidViewModel(application) {
    ...
    /**
     * Load a small, bounded recommendation set independently from playlists.
     * This keeps the home screen useful even when the playlist request is slow,
     * and downloaded songs provide a real offline fallback.
     */
    private fun loadRecommendations() {
        viewModelScope.launch {
            ...
            val recommendations = try {
                ...
                YoutubeDataExtractor.extractHomeRecommendations(
            ...
            val fallback = if (recommendations.isEmpty()) {
                runCatching { localSongDataSource.getDownloadedSongs().take(12) }
